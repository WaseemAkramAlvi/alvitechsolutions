  ...
  return (
    <section className="py-12 md:py-24 px-6">
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-7xl mx-auto rounded-[2rem] md:rounded-[3rem] bg-gradient-to-br from-primary to-secondary p-8 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/20"
      >
        {/* Decorative Circles */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-white/10 blur-3xl rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-black/10 blur-3xl rounded-full translate-x-1/2 translate-y-1/2" />
